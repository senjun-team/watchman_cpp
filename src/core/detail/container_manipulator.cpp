...
ContainerOSManipulator::ContainerOSManipulator(ProtectedContainers & protectedContainers)
    : m_protectedContainers(protectedContainers) {}

void ContainerOSManipulator::removeContainerFromOs(std::string const & id) {
...
void ContainerOSManipulator::createNewContainer(Config::ContainerType type,
